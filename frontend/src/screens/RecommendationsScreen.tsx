  ...
  return (
    <div className="mx-auto max-w-5xl space-y-4">
      <div className="card flex items-center justify-between p-4">
        <div>
          <div className="stat-label">Procurement rerouting recommendations</div>
        ...
        {activeRunId && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="rounded-lg border border-accent bg-accent-soft px-3.5 py-2 text-sm font-semibold text-accent-600 transition hover:bg-accent hover:text-white"
          >
            ⭳ Export brief
          </a>
        )}
